public class ModifiedBinarySearch_CeilingOfANumber {
    ...
    public static void main(String[] args) {
        System.out.println(searchCeilingOfANumber(new int[] { 4, 5, 7, 10 }, 7));
        System.out.println(searchCeilingOfANumber(new int[] { 4, 5, 7, 10 }, 6));
